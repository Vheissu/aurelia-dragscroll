System.register(["aurelia-templating"], function (exports_1, context_1) {
    ...
    var aurelia_templating_1, POINTER_START_EVENTS, POINTER_MOVE_EVENTS, POINTER_END_EVENTS, DragScroll;
    ...
    return {
        ...
        execute: function () {
            ...
            POINTER_START_EVENTS = ['mousedown', 'touchstart'];
            POINTER_MOVE_EVENTS = ['mousemove', 'touchmove'];
            POINTER_END_EVENTS = ['mouseup', 'touchend'];
            DragScroll = /** @class */ (function () {
            ...
            exports_1("DragScroll", DragScroll);
        }
    };
});
